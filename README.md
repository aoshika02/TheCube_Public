...
|  開発内容  |  期間  |
| ---- | ---- |
| 基本機能の開発 | 2025/12/03 ~ 2026/01/22 |
| ギミックの新規追加(ジャンプ・テレポート) | 2026/02/09 ~ 2026/02/20 |
| 技術構成・設計変更 | 2026/03/21 ~ 2026/03/29 |
| ステージセレクトショートカット機能・リザルト演出追加 | 2026/04/09 ~ 2026/04/13 |
